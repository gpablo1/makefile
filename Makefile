...
.PHONY: post-sign-bootimg
post-sign-bootimg:
	@echo "[INFO] Ejecutando hook de firmado post-build..."
	@/home/pablo/risingos7/device/xiaomi/umi/scripts/sign_bootimg_postbuild.sh

bootimage: post-sign-bootimg